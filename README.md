...
- Дописать тесты (Остались только тесты на ручки word_post, word_get)
- Написать продовый контейнер докера
- Добавить категории к словам (Скип)
- Доделать линтеры (Добавил)
- Реализовать функционал выдачи слов пользователю не из АПИ, а из БД (Скип)
- Описать в readme сервис
